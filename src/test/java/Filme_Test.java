...
public class Filme_Test {
    ...
    public void testCompareTo() {
        Filme_IF f1 = new Filme(1, "A", 5, 2020);
        Filme_IF f2 = new Filme(2, "B", 4, 2021);
        Filme_IF f3 = new Filme(3, "C", 5, 2019);
        Filme_IF f4 = new Filme(4, "D", 5, 2020);
        Filme_IF f5 = new Filme(5, "A", 5, 2020);
        ...
        assertEquals(0, f1.compareTo(f5)); // f1 e f5 devem ser considerados iguais, pois todos os atributos são iguais
    }

    @Test
    public void testToString() {
        Filme_IF f = new Filme(6, "Inception", 5, 2010);
        assertEquals("Inception (2010) [5]", f.toString());
    }

    @Test
    public void testSettersAndGetters() {
        Filme_IF f = new Filme(7, "Original", 3, 2018);
        f.setNome("Novo Nome");
        f.setNota(4);
        f.setAno(2020);
